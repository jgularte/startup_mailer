...
# Account Information
to = 'enter destination email' # Email to send to.
gmail_user = 'enter gmail handle' # Email to send from. (MUST BE GMAIL)
gmail_password = 'enter password' # Gmail password.
...
ipaddr_a = split_line_a[split_line_a.index(b'src')+1]
